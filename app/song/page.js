...
const Song = () => {
  ...
  return (
    <div>
      {songData
      ?
      <div className="text-xl md:text-5xl flex justify-center p-16 flex-col items-center">
        <p className='text-center'>You are listening to {songData.name} by {songData.artists[0].name}</p>
